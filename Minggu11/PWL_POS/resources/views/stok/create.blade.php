            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <select class="form-control" id="barang_id" name="barang_id" required>
                        ...
                        <option value="{{ $item->barang_id }}" @if(old('barang_id') == $item->barang_id) selected @endif>{{ $item->barang_nama }}</option>
                        @endforeach
                    </select>
                    @error('barang_id')
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <select class="form-control" id="user_id" name="user_id" required>
                        ...
                        <option value="{{ $item->user_id }}" @if(old('user_id') == $item->user_id) selected @endif>{{ $item->username }}</option>
                        @endforeach
                    </select>
                    @error('user_id')
                        <small class="form-text text-danger">{{ $message }}</small>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <select class="form-control" id="supplier_id" name="supplier_id" required>
                        ...
                        <option value="{{ $item->supplier_id }}" @if(old('supplier_id') == $item->supplier_id) selected @endif>{{ $item->supplier_nama }}</option>
                        @endforeach
                    </select>
                    @error('supplier_id')
                        <small class="form-text text-danger">{{ $message }}</small>
